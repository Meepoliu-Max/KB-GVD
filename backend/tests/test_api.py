...
from app.models import KbDocument, DocType, Stage1Output, Stage2Output, Stage3Output, Stage4Output
...
class TestWebSocket(unittest.TestCase):
    ...
    def test_websocket_receive_progress(self):
        ...
        from app.api.ws_manager import push_progress
    ...
    def test_websocket_receive_result(self):
        ...
        from app.api.ws_manager import push_result
    ...
    def test_websocket_receive_error(self):
        ...
        from app.api.ws_manager import push_error
