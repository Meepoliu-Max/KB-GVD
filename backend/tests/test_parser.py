...
from app.core.parser.base import Formula, Heading, Table
...
class TestMineruParserBoundary(unittest.TestCase):
    ...
    def test_mineru_not_installed(self):
        ...
        try:
            ...
            with patch("app.core.parser.mineru_parser.shutil.which", return_value=None):
...
class TestParserFactory(unittest.TestCase):
    ...
    def test_returns_mineru_parser(self):
        ...
        self.assertIsInstance(p, MineruParser)
