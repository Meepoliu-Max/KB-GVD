...
from app.core.llm.deepseek_client import _is_retryable_api_error
...
class TestModelSwitching(unittest.TestCase):
    ...
    @patch("app.core.llm.deepseek_client.OpenAI")
...
class TestAsyncInterface(unittest.TestCase):
    ...
    @patch("app.core.llm.deepseek_client.AsyncOpenAI")
